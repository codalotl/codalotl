...
require (
	github.com/charmbracelet/bubbles v0.21.0 // charmbracelet/* packages are dependency bombs (otherwise, they're good software)
	github.com/charmbracelet/bubbletea v1.3.10 // charmbracelet/* packages are dependency bombs (otherwise, they're good software)
)
