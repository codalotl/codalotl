...
Human review:
- It looks like tui removes agentsmd, but noninteractive does not. Unless you can articulate a great reason for this, these packages should no longer be directly concerned with AGENTS.md -- the concern is moved to agentbuilder.
