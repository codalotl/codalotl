...
background: this repo is 'codalotl', a go-focused coding agent. There's an "orchestrator" mode -- see internal/agentbuilder for its prompt. It's designed to take an idea to a mergable state in steps, commiting work as it goes. In fact, you may be reading this **as** codalotl in orchestrator mode -- welcome to self improvement (alternatively: you might be reading this as codex. we love you too).
...
In this PR:
- Define a new tool, `review_spec_changes`, which accepts a package and a message. The message might be something like "review the uncommited changes to SPEC.md in your package. broader context: @.prs/2026-02-01_1_some-feature.md. Other specifics: abc".
...
- Add tool to the orchestrator agent
