...
- The `paths` parameter is an arrray, where each element may be either a package directory within the sandbox (relative to the sandbox root) or a Go import path.
