...
- Tools have a Call and a Result.
    ...
    - Exception: if the tool's presentation behavior is append, do NOT replace the Call with the Result; instead print both as separate messages. Built-in subagent-style tools use append behavior.
