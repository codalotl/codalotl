...
//     children's children, parent's children, etc). Stop when we get language that is not LangUnknown. If the BFS exhausts without finding a known language,
//     return LangUnknown. Does not traverse beyond absRootDir.
//
