...
//
// The formatter sanitizes display text by expanding tabs and escaping control bytes. It can emit ANSI colors and effects for semantic roles such as accent, success,
// error, and action text, or produce unstyled output when configured with PlainText.
//
