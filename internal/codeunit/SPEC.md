...
// Returns true if the code unit includes path. path can be relative to baseDir or absolute. path can be a directory or a file.
// A non-existent path return true iff its filepath.Dir is in the file set.
