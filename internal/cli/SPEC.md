...
Effective Model: gpt-5.6-sol-high
...
Notes:
- `--no-browser` prints verification instructions without opening a browser.
- Does not require existing LLM configuration.

### codalotl auth openai logout

Deletes saved OpenAI ChatGPT subscription credentials.
