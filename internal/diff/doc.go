...
//
// Granularity: The exact grouping of changes into hunks/lines/spans is a policy choice of DiffText and may evolve. Consumers should rely on the invariants above rather than any particular
// chunking strategy.
//
...
//   - Diff.RenderPretty emits a simplified, colorized view (no @@ hunk headers) with "+"/"-"/" " line markers and highlighted intra-line additions/deletions. Filenames are optional;
//     pass "" to omit headers. contextSize controls how many unchanged lines are shown around changes.
